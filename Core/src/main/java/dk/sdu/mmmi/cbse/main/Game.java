...
public class Game {
    ...
    private final List<IEntityProcessingService> entityProcess;
    private final List<IPostEntityProcessingService> postProcess;


    Game(GameData gameData, World world, List<IGamePluginService> gamePlugins, List<IEntityProcessingService> entityProcess, List<IPostEntityProcessingService> postProcess) {
    ...
    private void update() {
        for (IEntityProcessingService entityProcess : getEntityProcessingServices()) {
            entityProcess.process(gameData, world);
        }
